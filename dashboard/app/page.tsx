...
export default function HomePage() {
  return (
    <main className="min-h-screen flex flex-col items-center bg-white text-[#1a1a1a]">
      {/* Hero */}
      <section className="w-full max-w-3xl mx-auto px-6 pt-20 pb-16 md:pt-32 md:pb-24">
        <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-4 font-mono">
          whizmob
        </h1>
        <p className="text-lg md:text-xl text-[#6b7280] mb-10 max-w-2xl leading-relaxed">
      ...
      <hr className="w-full max-w-3xl mx-auto border-[#d1d5db]" />
        ...
        <div className="command-list">
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <p className="text-sm text-[#6b7280] mb-3">
                ...
                <strong className="text-[#1a1a1a]">mobs</strong>.
              </p>
                ...
                <table className="w-full text-left text-sm">
                  ...
                  <tbody className="font-mono text-sm">
                    <tr className="border-b border-[#d1d5db]">
                      <td className="py-2 pr-8 text-[#12497a]">~/.claude/</td>
                      <td className="py-2 text-[#6b7280]">Agents, skills, MCP servers, settings</td>
                    </tr>
                    <tr className="border-b border-[#d1d5db]">
                      <td className="py-2 pr-8 text-[#12497a]">~/.cursor/</td>
                      <td className="py-2 text-[#6b7280]">Agents, MCP servers, settings</td>
                    </tr>
                    <tr className="border-b border-[#d1d5db]">
                      <td className="py-2 pr-8 text-[#12497a]">~/.codex/</td>
                      <td className="py-2 text-[#6b7280]">Skills</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-xs text-[#6b7280] mt-3">
                ...
                <code className="text-[#12497a]">.claude/</code> configs.
              </p>
            </div>
          </details>
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <p className="text-sm text-[#6b7280]">
                ...
                <code className="text-[#12497a]">--output path</code> for a
                custom location.
              </p>
            </div>
          </details>
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <div className="rounded-lg border border-[#d1d5db] overflow-hidden bg-[#f5f7fa] p-4">
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <p className="text-sm text-[#6b7280]">
                Filter by type with{" "}
                <code className="text-[#12497a]">--type</code>, platform with{" "}
                <code className="text-[#12497a]">--platform</code>, or see mob
                memberships with{" "}
                <code className="text-[#12497a]">--hook</code>.
              </p>
            </div>
          </details>
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <p className="text-sm text-[#6b7280]">
                ...
                work together. Use{" "}
                <code className="text-[#12497a]">mob list</code> and{" "}
                <code className="text-[#12497a]">mob show &lt;name&gt;</code> to
                view them.
              </p>
            </div>
          </details>
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <p className="text-sm text-[#6b7280]">
                ...
                <code className="text-[#12497a]">manifest.json</code> &mdash; no
                binaries, git-friendly. Copy it however you like.
              </p>
            </div>
          </details>
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <p className="text-sm text-[#6b7280]">
                Use{" "}
                <code className="text-[#12497a]">--dry-run</code> to preview
                before installing.{" "}
                <code className="text-[#12497a]">--param</code> passes content
                parameters (names, paths) for the new environment.{" "}
                <code className="text-[#12497a]">--list</code> shows available
                pre-built mobs.
              </p>
            </div>
          </details>
          ...
          <details className="command-item">
            ...
            <div className="command-detail">
              ...
              <p className="text-sm text-[#6b7280]">
                ...
                <code className="text-[#12497a]">--dry-run</code> to preview or{" "}
                <code className="text-[#12497a]">--force</code> to overwrite.
              </p>
            </div>
          </details>
        </div>
      ...
      <section className="w-full max-w-3xl mx-auto px-6 py-16">
        ...
        <ul className="space-y-3 text-[#6b7280] text-sm mb-8">
          <li>
            <strong className="text-[#1a1a1a]">Node.js 20+</strong>{" "}
            &mdash; check with{" "}
            <code className="text-[#12497a]">node --version</code>
          </li>
          <li>
            <strong className="text-[#1a1a1a]">macOS:</strong>{" "}
            <code className="text-[#12497a]">xcode-select --install</code> for
            native build tools
          </li>
          <li>
            <strong className="text-[#1a1a1a]">Linux:</strong>{" "}
            <code className="text-[#12497a]">build-essential</code> and{" "}
            <code className="text-[#12497a]">python3</code>
          </li>
          <li>
            <strong className="text-[#1a1a1a]">At least one AI tool:</strong>{" "}
        ...
        <details className="command-item">
          <summary>
            <span className="text-[#1a1a1a] font-medium">Troubleshooting</span>
          </summary>
          <div className="command-detail space-y-4">
            <div>
              ...
              <p className="text-sm text-[#6b7280]">
                ...
                <code className="text-[#12497a]">xcode-select --install</code>.
                Linux:{" "}
                <code className="text-[#12497a]">
            ...
            <div>
              ...
              <p className="text-sm text-[#6b7280]">
                ...
                <code className="text-[#12497a]">~/.cursor/</code>, and{" "}
                <code className="text-[#12497a]">~/.codex/</code>. If none
                exist, there&apos;s nothing to find yet.
              </p>
            </div>
            <div>
              <p className="font-semibold mb-1 text-sm">
              ...
              <p className="text-sm text-[#6b7280]">
                ...
                <code className="text-[#12497a]">npx whizmob dashboard</code>.
              </p>
            </div>
          </div>
        </details>
      ...
      {/* Footer */}
      <footer className="w-full max-w-3xl mx-auto px-6 py-12 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#6b7280]">
